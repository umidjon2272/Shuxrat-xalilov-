...
export const STATS = [
  ...
  { num: '3.2M', label: 'Umumiy Reach' },
  { num: '92%', label: 'Mijoz Qoniqishi' },
  { num: '2.8x', label: "O'rtacha ROI" },
];

export const SERVICES = [
  {
    icon: "📈",
    title: "Target bo'yicha",
    desc: "Biznesingiz uchun qisqa va uzoq muddatli sotuvni oshiradigan SMM strategiyalarini ishlab chiqish."
  },
  {
    icon: "📱",
    title: "Shaxsiy brend bo'yicha",
    desc: "Instagram, Telegram va boshqa platformalar uchun vizual va matniy kontent strategiyasini yaratish."
  },
  {
    icon: "🎯",
    title: "SMM bo'yicha",
...
export const PLANS = [
  {
    name: 'Starter',
    popular: false,
    features: ['2 ijtimoiy tarmoq', '12 post / oy', 'Kontent kalendar', 'Oylik hisobot', 'Telegram support'],
    cta: 'Boshlash',
  },
  {
    name: 'Pro',
    popular: true,
    features: ['4 ijtimoiy tarmoq', '30 post + Stories', 'Targetted reklama', 'Haftalik hisobot', 'Analitika dashboard', '24/7 support'],
    cta: "Eng Zo'ri",
  },
  {
    name: 'Business',
    popular: false,
    features: ['Barcha platformalar', 'Cheksiz kontent', 'Reklama', 'Influencer boshqaruv', 'Kunlik hisobot', 'Shaxsiy menejer'],
    cta: "Bog'lanish",
  },
];

export const CONTACTS = [
  { icon: '✈️', label: 'Telegram', value: '@shuxrat_xalilov', href: 'https://t.me/shuxrat_xalilov', color: '#0ea5e9' },
  { icon: '📸', label: 'Instagram', value: 'shuxratxalilov_', href: 'https://www.instagram.com/shuxratxalilov_?igsh=b2kzeTV6eWV5ZW9q', color: '#e1306c' },
  { icon: '📞', label: 'Telefon', value: '+998 94 880 59 69', href: 'tel:+998948805969', color: '#6366f1' },
];
